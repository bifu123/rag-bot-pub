    ...
    if chat_type in chat_type_allow and get_urls(message)[0] == "no": 
        ...
        if current_lock_state == 1:
            ...
            # 其它命令和问答
                ...
                # 命令： /帮助 
                elif command_name in ("/帮助", f"{at_string} /帮助"):
                    response_message = f"请切换至“插件问答”状态，再进入“help”命名空间后提出问题，或者打开https://www.github.com/bifu123/rag-bot-pub"
